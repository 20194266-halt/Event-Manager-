...
int main(int argc, char* argv[]) {
	...
	while (1) {
		...
		while (1) {
			...
			cout << "9.Test Refresh Invite" << endl;
			cout << "10.Test Refresh Request" << endl;
			...
			case 1: {
				...
				string messageToServer = "CREATEUSER " + username + "|" + password + "|" + ENDING_DELIMITER;
			...
			case 2: {
				...
				cout << "Type in your password: ";
				password = inputMessage();
				messageToServer = "USER " + username + "|" + password + "|" + ENDING_DELIMITER;
				sendMessage(client, messageToServer);
				while (1) {
					int retToClient = recv(client, buff, BUFF_SIZE, 0);
					messageToClient.append(buff);
			...
			case 3: {
				...
				messageToServer = messageToServer + creator + "|" + evName + "|" + evPlace + "|" + evTime + "|" + evDes + "|" + ENDING_DELIMITER;
			...
			case 5: {//INVITE
				...
				id = inputMessage();
				messageToServer = "INVITE " + sender + "|" + receiver + "|" +  id + "|"  + ENDING_DELIMITER;
				sendMessage(client, messageToServer);
				while (1) {
					int retToClient = recv(client, buff, BUFF_SIZE, 0);
					messageToClient.append(buff);
			...
			case 6: {//INVITEREPLY
				...
				cout << "Type in your eventId: ";
				id = inputMessage();
				messageToServer = "INVITEREPLY " + sender + "|" + receiver + "|" + id + "|" + "OK"+"|" + ENDING_DELIMITER;
				sendMessage(client, messageToServer);
				while (1) {
					int retToClient = recv(client, buff, BUFF_SIZE, 0);
					messageToClient.append(buff);
			...
			case 7: {//REQUEST
				...
				cout << "Type in your eventId: ";
				id = inputMessage();
				messageToServer = "REQUEST " + sender + "|" + receiver + "|" + id + "|" + ENDING_DELIMITER;
				sendMessage(client, messageToServer);
				while (1) {
					int retToClient = recv(client, buff, BUFF_SIZE, 0);
					messageToClient.append(buff);
			...
			case 8: {//REQUESTREPLY
				...
				cout << "Type in your eventId: ";
				id = inputMessage();
				messageToServer = "REQUESTREPLY " + sender + "|" + receiver + "|" + id + "|" + "OK" + "|" + ENDING_DELIMITER;
				sendMessage(client, messageToServer);
				while (1) {
					int retToClient = recv(client, buff, BUFF_SIZE, 0);
					messageToClient.append(buff);
			...
			case 9: {//REFRESHREQUEST
				...
				cout << "Type in your sender: ";
				sender = inputMessage();
				messageToServer = "REFRESHREQUEST " + sender + ENDING_DELIMITER;
			...
			case 10: {//REFRESHINVITE
				...
				cout << "Type in your sender: ";
				sender = inputMessage();
				messageToServer = "REFRESHINVITE " + sender + ENDING_DELIMITER;
				sendMessage(client, messageToServer);
				while (1) {
					int retToClient = recv(client, buff, BUFF_SIZE, 0);
					messageToClient.append(buff);
