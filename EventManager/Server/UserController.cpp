...
string createAccount(string s) {
	...
	if (cnt < 2) {
		...
		cout << "Client register with username: " << name << endl;
		cout << "Client register with Pass: " << pass << endl;
...
string loginHandling(string s) {
	...
	if (cnt<2) {
		...
		cout << "Client login with username: " << name << endl;
		cout << "Client login with password: " << pass << endl;
